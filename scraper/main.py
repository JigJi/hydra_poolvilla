...
engine = create_async_engine(
    DATABASE_URL, 
    echo=False,
    pool_pre_ping=True,  # ✅ เช็คว่า Connection ยังดีอยู่ไหมก่อนใช้
...
# --- 🎯 CONFIGURATION ---
TARGET_LOCATIONS = [
    {"name": "หัวหิน", "province": "ประจวบคีรีขันธ์"}, # 🔥 King of Pool Villa
    {"name": "ชะอำ", "province": "เพชรบุรี"},         # น้องคู่บุญหัวหิน
    {"name": "ปราณบุรี", "province": "ประจวบคีรีขันธ์"}, # สายชิลล์ พูลวิลล่าสวยๆ เยอะ
]

# TARGET_LOCATIONS = [
#     # --- ภูเก็ต ---
#     {"name": "เมืองภูเก็ต", "province": "ภูเก็ต"},
#     {"name": "กะทู้", "province": "ภูเก็ต"},
#     {"name": "ถลาง", "province": "ภูเก็ต"},
#     {"name": "หาดป่าตอง", "province": "ภูเก็ต"},
#     {"name": "หาดกะรน", "province": "ภูเก็ต"},
#     {"name": "หาดกะตะ", "province": "ภูเก็ต"},
#     {"name": "หาดราไวย์", "province": "ภูเก็ต"},
#     {"name": "หาดกมลา", "province": "ภูเก็ต"},

#     # --- ชลบุรี ---
#     {"name": "เมืองพัทยา", "province": "ชลบุรี"},
#     {"name": "พัทยากลาง", "province": "ชลบุรี"},
#     {"name": "พัทยาใต้", "province": "ชลบุรี"},
#     {"name": "พัทยาเหนือ", "province": "ชลบุรี"},
#     {"name": "หาดจอมเทียน", "province": "ชลบุรี"},
#     {"name": "นาจอมเทียน", "province": "ชลบุรี"},
#     {"name": "บางแสน", "province": "ชลบุรี"},
#     {"name": "สัตหีบ", "province": "ชลบุรี"},
#     {"name": "บางละมุง", "province": "ชลบุรี"},
#     {"name": "เกาะล้าน", "province": "ชลบุรี"},

#     # --- ประจวบคีรีขันธ์ ---
#     {"name": "หัวหิน", "province": "ประจวบคีรีขันธ์"},
#     {"name": "ปราณบุรี", "province": "ประจวบคีรีขันธ์"},
#     {"name": "สามร้อยยอด", "province": "ประจวบคีรีขันธ์"},
#     {"name": "กุยบุรี", "province": "ประจวบคีรีขันธ์"},
#     {"name": "ทับสะแก", "province": "ประจวบคีรีขันธ์"},
#     {"name": "บางสะพาน", "province": "ประจวบคีรีขันธ์"},

#     # --- เพชรบุรี ---
#     {"name": "ชะอำ", "province": "เพชรบุรี"},
#     {"name": "แก่งกระจาน", "province": "เพชรบุรี"},
#     {"name": "หาดเจ้าสำราญ", "province": "เพชรบุรี"},

#     # --- สุราษฎร์ธานี ---
#     {"name": "เกาะสมุย", "province": "สุราษฎร์ธานี"},
#     {"name": "เกาะพะงัน", "province": "สุราษฎร์ธานี"},
#     {"name": "เกาะเต่า", "province": "สุราษฎร์ธานี"},
#     {"name": "เชี่ยวหลาน", "province": "สุราษฎร์ธานี"},

#     # --- กระบี่ ---
#     {"name": "เมืองกระบี่", "province": "กระบี่"},
#     {"name": "อ่าวนาง", "province": "กระบี่"},
#     {"name": "เกาะลันตา", "province": "กระบี่"},
#     {"name": "หนองทะเล", "province": "กระบี่"},

#     # --- นครราชสีมา ---
#     {"name": "ปากช่อง", "province": "นครราชสีมา"},
#     {"name": "เขาใหญ่", "province": "นครราชสีมา"},
#     {"name": "วังน้ำเขียว", "province": "นครราชสีมา"},
#     {"name": "หมูสี", "province": "นครราชสีมา"},

#     # --- เชียงใหม่ ---
#     {"name": "เมืองเชียงใหม่", "province": "เชียงใหม่"},
#     {"name": "แม่ริม", "province": "เชียงใหม่"},
#     {"name": "หางดง", "province": "เชียงใหม่"},
#     {"name": "สันทราย", "province": "เชียงใหม่"},
#     {"name": "แม่แตง", "province": "เชียงใหม่"},
#     {"name": "ม่อนแจ่ม", "province": "เชียงใหม่"},

#     # --- ระยอง ---
#     {"name": "เมืองระยอง", "province": "ระยอง"},
#     {"name": "แกลง", "province": "ระยอง"},
#     {"name": "บ้านเพ", "province": "ระยอง"},
#     {"name": "เกาะเสม็ด", "province": "ระยอง"},

#     # --- ตราด ---
#     {"name": "เกาะช้าง", "province": "ตราด"},
#     {"name": "เกาะกูด", "province": "ตราด"},

#     # --- กาญจนบุรี ---
#     {"name": "เมืองกาญจนบุรี", "province": "กาญจนบุรี"},
#     {"name": "ไทรโยค", "province": "กาญจนบุรี"},
#     {"name": "ศรีสวัสดิ์", "province": "กาญจนบุรี"},

#     # --- นครนายก ---
#     {"name": "เมืองนครนายก", "province": "นครนายก"},
#     {"name": "สาริกา", "province": "นครนายก"},
...
async def handle_genius_popup(page):
    try:
        # Selector ของปุ่มปิด (รวมหลายแบบ)
        popup_selectors = [
            'button[aria-label="ปิดข้อมูลเกี่ยวกับการเข้าสู่ระบบ"]',
            'button[aria-label="Dismiss sign-in info."]',
            'button[aria-label="Close"]', 
            '.bui-modal__close',
            'div[role="dialog"] button[aria-label="Close"]' # แบบใหม่
        ]
        
        for sel in popup_selectors:
            if await page.is_visible(sel):
                print(f"      🔫 Bang! Popup killed ({sel})")
                await page.click(sel)
                await page.wait_for_timeout(300) # รอ Animation ปิดนิดนึง
                return # ยิงตัวเดียวพอ
    except: pass
...
async def gentle_scroll_to_bottom(page):
    """
    Hybrid Scroll: เร็วขึ้น แต่ยังปลอดภัย (ไม่วาร์ป)
    """
    print("      🏃‍♂️ Scrolling (Hybrid Mode)...")
    ...
    # วนลูปจนกว่าจะถึงพื้น
    while True:
        # ⚡ ปรับสเต็ปให้ใหญ่ขึ้น (800-1200px) = เร็วขึ้น
        ...
        # ⚡ ลดเวลาพักลง (เหลือ 0.2 - 0.5 วิ) = ไม่ค้างนาน
        await asyncio.sleep(random.uniform(0.2, 0.5))
        
        # ดัก Popup (เช็คทุกๆ 3 รอบการเลื่อนพอ ไม่ต้องทุกรอบ)
        if random.random() > 0.7: 
            await handle_genius_popup(page)

        # เช็คว่าถึงพื้นหรือยัง
        new_height = await page.evaluate("document.body.scrollHeight")
        
        if current_scroll >= new_height:
            # ถึงพื้นแล้ว... ลองรอนิดนึงเผื่อโหลดเพิ่ม (Infinite Scroll)
            ...
            if final_height > new_height:
                ...
                print("      ✨ Infinite scroll loaded more items...")
                continue
            else:
                # สุดทางรัก
                break
    ...
    # กดปุ่ม End ย้ำอีกทีเพื่อความชัวร์ (เผื่อขาด)
    await page.keyboard.press("End")
...
async def process_location(page, location):
    ...
    params = {
        "ss": city,
        "nflt": "ht_id=213;hotelfacility=433", # Pool Villa
        "group_adults": "2",
        "no_rooms": "1",
